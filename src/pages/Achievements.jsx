...
const ACHIEVEMENTS = [
  // Study time
  { id:'st_1h',   cat:'study',   icon:'⏱️',  name:'First Hour',      desc:'Logged your first hour of study time.',    how:'Log 1 hour total study time.',         xp:10, threshold:60,    field:'totalMins' },
  { id:'st_5h',   cat:'study',   icon:'📖',  name:'Scholar',          desc:'5 hours of focused learning.',             how:'Log 5 hours total study time.',        xp:10, threshold:300,   field:'totalMins' },
  { id:'st_10h',  cat:'study',   icon:'🎓',  name:'Dedicated',        desc:'10 hours invested in yourself.',           how:'Log 10 hours total study time.',       xp:10, threshold:600,   field:'totalMins' },
  { id:'st_25h',  cat:'study',   icon:'🔬',  name:'Researcher',       desc:'25 hours of serious study.',               how:'Log 25 hours total study time.',       xp:10, threshold:1500,  field:'totalMins' },
  { id:'st_50h',  cat:'study',   icon:'🏆',  name:'Achiever',         desc:'50 hours — you\'re unstoppable.',          how:'Log 50 hours total study time.',       xp:10, threshold:3000,  field:'totalMins' },
  { id:'st_100h', cat:'study',   icon:'💎',  name:'Century Club',     desc:'100 hours of dedicated learning.',         how:'Log 100 hours total study time.',      xp:10, threshold:6000,  field:'totalMins' },
  ...
  // Streaks
  { id:'sk_3',    cat:'streak',  icon:'🔥',  name:'On Fire',          desc:'3 days in a row — momentum is building.',  how:'Study 3 days in a row.',              xp:10, threshold:3,     field:'streak' },
  { id:'sk_7',    cat:'streak',  icon:'🗓️',  name:'Week Warrior',     desc:'A full week of showing up.',               how:'Study 7 days in a row.',              xp:10, threshold:7,     field:'streak' },
  { id:'sk_14',   cat:'streak',  icon:'💪',  name:'Fortnight Force',  desc:'Two weeks of daily dedication.',           how:'Study 14 days in a row.',             xp:10, threshold:14,    field:'streak' },
  { id:'sk_30',   cat:'streak',  icon:'🏅',  name:'Monthly Grind',    desc:'30 days straight — legendary.',            how:'Study 30 days in a row.',             xp:10, threshold:30,    field:'streak' },
...
const CATEGORIES = [
  ...
  { key: 'study',   label: 'Study Time', icon: '📖' },
